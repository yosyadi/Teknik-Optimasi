...
class Selection
{
    ...
    // membuat penampung hasil fitness pada populasi
    ...
    // hasil fitness value akan disort
    function sortFitTemporaryPopulation()
    {
        ...
        rsort($fitTemporaryPopulation); //mengurutkan asosiatif array secara descending
    ...
    //memilih individu terbaik dari gabungan offstring
